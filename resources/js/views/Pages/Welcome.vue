<script setup>
import FeaturesCard from '@/views/Components/FeaturesCard.vue'
import PricingCard from '@/views/Components/PricingCard.vue'
import Accordion from '@/views/Components/shadcn/ui/accordion/Accordion.vue'
import AccordionContent from '@/views/Components/shadcn/ui/accordion/AccordionContent.vue'
import AccordionItem from '@/views/Components/shadcn/ui/accordion/AccordionItem.vue'
import AccordionTrigger from '@/views/Components/shadcn/ui/accordion/AccordionTrigger.vue'
import Badge from '@/views/Components/shadcn/ui/badge/Badge.vue'
import Button from '@/views/Components/shadcn/ui/button/Button.vue'
import Terminal from '@/views/Components/Terminal.vue'
