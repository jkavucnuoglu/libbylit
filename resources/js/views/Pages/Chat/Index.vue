...
import Alert from '@/views/Components/shadcn/ui/alert/Alert.vue'
import AlertDescription from '@/views/Components/shadcn/ui/alert/AlertDescription.vue'
import AlertTitle from '@/views/Components/shadcn/ui/alert/AlertTitle.vue'
import { Button } from '@/views/Components/shadcn/ui/button/index.js'

import { Label } from '@/views/Components/shadcn/ui/label/index.js'
import Skeleton from '@/views/Components/shadcn/ui/skeleton/Skeleton.vue'
