...
import AuthenticationCardLogo from '@/views/Components/LogoRedirect.vue'
import Button from '@/views/Components/shadcn/ui/button/Button.vue'
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from '@/views/Components/shadcn/ui/card/index.js'
import Checkbox from '@/views/Components/shadcn/ui/checkbox/Checkbox.vue'
import Input from '@/views/Components/shadcn/ui/input/Input.vue'
import Label from '@/views/Components/shadcn/ui/label/Label.vue'
import Sonner from '@/views/Components/shadcn/ui/sonner/Sonner.vue'
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/views/Components/shadcn/ui/tabs/index.js'
import SocialLoginButton from '@/views/Components/SocialLoginButton.vue'
