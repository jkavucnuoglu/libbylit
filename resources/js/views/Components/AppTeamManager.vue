<script setup>
import { Avatar, AvatarFallback } from '@/views/Components/shadcn/ui/avatar/index.js'
import {
  Command,
  CommandGroup,
  CommandInput,
  CommandItem,
  CommandSeparator,
} from '@/views/Components/shadcn/ui/command/index.js'
import CommandEmpty from './shadcn/ui/command/CommandEmpty.vue'
import CommandList from './shadcn/ui/command/CommandList.vue'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuTrigger,
} from '@/views/Components/shadcn/ui/dropdown-menu/index.js'
import SidebarMenuButton from './shadcn/ui/sidebar/SidebarMenuButton.vue'
